"""
This program converts spatial data from any any format supported by OGR to any other.
...
try:
    ...
    # input_file is any filename as a string. Use "path/to/file.xxx" format. If the file doesn't exist, we raise an
    # error.
