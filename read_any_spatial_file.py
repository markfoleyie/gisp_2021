...
# @begin.start
# @begin.logging
def run(input_file: "Input Spatial Data File"):
    """
    Reads any format supported by OGR such as ESRI Shapefile, GeoJSON and Geopackage.
    input_file is any filename as a string. Use "path/to/file.xxx" format. If the file doesn't exist,
    we raise an error.
    """
    try:
        ...
        from utilities import fiona_supported_drivers as fsd

        import fiona
        from shapely.geometry import shape, mapping, Point, LineString, Polygon, MultiLineString, MultiPolygon
